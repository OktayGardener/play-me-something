...
class Example:
    ...
    def _generate_examples(filename_queue):
        print("reating tfrecord reader to start reading")
        ...
        return features['context'], features['time_of_day'], features['time_of_week'], \
               ...
               features['user_gender'], features['user_platform'], features['history'].values
    ...
    def all_fields(self):
        ...
        if self.records_dir:
            ...
            user_gender, user_platform, history = self._generate_examples(filename_queue) # noqa
            # God damnit: https://github.com/tensorflow/tensorflow/issues/7407
            return tf.train.batch([
                context, time_of_day, time_of_week, user_country, user_city, user_age, user_gender,
                user_platform, history
            ],

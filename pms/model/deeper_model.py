...
class DeeperContextModel:
    ...
    def __init__(
            self, example, metrics, country_vocabulary_size, city_vocabulary_size,
            context_vocabulary_size, history_size, embedding_size
    ):
        ...
        self.mean_reciprocal_rank = tf.placeholder(shape=[], dtype=tf.float64)
        self.mean_accuracy = tf.placeholder(shape=[], dtype=tf.float64)
        self.num_predicted_examples = tf.placeholder(shape=[], dtype=tf.int32)
